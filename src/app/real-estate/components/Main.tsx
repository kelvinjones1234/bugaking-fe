...
// // Simple hook-like component for counting up numbers
...
//   return (
//     <main ref={containerRef} className="w-full bg-[#f8f7f6] text-[#171512] font-sans antialiased selection:bg-[#d0a539] selection:text-white overflow-hidden">
...
//             <motion.h1 variants={fadeInUp} className="text-white text-4xl sm:text-6xl lg:text-8xl font-black leading-[1.1] tracking-tight drop-shadow-2xl">
//               Own Property <br className="hidden md:block"/> with <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d0a539] via-[#f4d072] to-[#d0a539] bg-[length:200%_auto] animate-shine">Flexible Payments</span>
//             </motion.h1>
            
//             <motion.p variants={fadeInUp} className="text-white/90 text-base sm:text-xl lg:text-2xl font-light max-w-2xl mx-auto leading-relaxed drop-shadow-md">
//               Break the barriers to real estate. Secure premium assets today and pay at your own pace through our proprietary ownership model.
//             </motion.p>
            
//             <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center pt-8 w-full sm:w-auto">
//               <motion.button 
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-[#d0a539] text-[#171512] px-8 py-4 sm:px-10 sm:py-5 rounded-xl text-sm sm:text-base font-black uppercase tracking-widest shadow-xl shadow-[#d0a539]/20 w-full sm:w-auto"
//               >
//                 Start Investing
//               </motion.button>
//               <motion.button 
...
//                 whileTap={{ scale: 0.95 }}
//                 className="group bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 py-4 sm:px-10 sm:py-5 rounded-xl text-sm sm:text-base font-black uppercase tracking-widest w-full sm:w-auto flex items-center justify-center gap-2"
//               >
//                 View Properties
//                 <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//               </motion.button>
...
//           >
//             {[
//               { icon: Calendar, title: "Custom Schedules", desc: "Tailor your payment frequency to match your cash flow.", progress: 33 },
//               { icon: ShieldCheck, title: "Zero Hidden Fees", desc: "Transparent pricing with no surprise maintenance costs.", progress: 66 },
//               { icon: TrendingUp, title: "Ownership Progress", desc: "Watch your legal stake grow in real-time as you pay.", progress: 85 }
//             ].map((card, idx) => (
//               <motion.div 
//                 key={idx}
//                 variants={fadeInUp}
...
//                 </div>
//                 <h3 className="text-xl font-black mb-4 uppercase">{card.title}</h3>
//                 <p className="text-[#171512]/60 leading-relaxed mb-6 text-sm">{card.desc}</p>
...
//                   className="absolute w-full h-3 -bottom-1 left-0 text-[#d0a539]/30" viewBox="0 0 100 10" preserveAspectRatio="none"
//                 >
//                   <path d="M0 5 Q 50 10 100 5" stroke="currentColor" strokeWidth="2" fill="none" />
//                 </motion.svg>
//               </span>
...
//                 whileInView="visible"
//                 viewport={{ once: true }}
//                 className="flex flex-col md:flex-row justify-between gap-12 md:gap-4"
//             >
//               {[
//                 { step: 1, title: 'Choose', desc: 'Browse portfolio', active: false },
//                 { step: 2, title: 'Select Plan', desc: 'Customize terms', active: false },
//                 { step: 3, title: 'Pay', desc: 'Initial deposit', active: false },
//                 { step: 4, title: 'Secure', desc: 'Documentation', active: false },
//                 { step: 5, title: 'Earn', desc: 'Yield benefits', active: true }
//               ].map((item, idx) => (
//                 <motion.div 
//                     key={idx} 
//                     variants={scaleIn}
...
//                 >
//                   <div className={`w-12 h-12 shrink-0 rounded-full flex items-center justify-center font-bold text-lg md:mb-6 transition-all duration-300 shadow-lg ${item.active ? 'bg-[#d0a539] text-[#171512] ring-4 ring-[#d0a539]/20' : 'bg-[#171512] text-[#d0a539] border-2 border-[#d0a539]'}`}>
//                     {item.active ? <CheckCircle2 className="w-6 h-6" /> : item.step}
//                   </div>
//                   <div className="md:text-center pt-1 md:pt-0">
//                     <h5 className="font-black text-base uppercase mb-1 md:mb-2">{item.title}</h5>
...
//               <div className="space-y-8">
//                 {[
//                   { icon: Scale, title: "Legal Clarity", desc: "Every unit is backed by registered legal titles." },
//                   { icon: Landmark, title: "Investor Rights", desc: "Comprehensive framework ensuring voting rights." },
//                   { icon: Lock, title: "Escrow Security", desc: "All payments are managed through fiduciary accounts." }
//                 ].map((item, i) => (
...
//                     </div>
//                     <div>
//                       <h4 className="font-bold uppercase text-sm mb-2 text-[#d0a539]">{item.title}</h4>
...
//               >
//                 <span className="w-1.5 h-1.5 rounded-full bg-[#d0a539]"></span> Live
//               </motion.span>
//             </div>
...
//                     <NumberCounter value={65} /><span className="text-[#d0a539] text-2xl">%</span>
//                   </span>
//                 </div>
//                 <div className="w-full h-4 bg-[#171512]/5 rounded-full overflow-hidden">
//                   <motion.div 
...
//                         transition={isPayDay ? { type: "spring", stiffness: 300, delay: 1 } : {}}
//                         className={`py-1.5 sm:py-2 rounded-lg font-medium transition-colors ${
//                           isPayDay 
