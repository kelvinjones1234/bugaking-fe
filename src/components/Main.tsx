...
// // Helper component for the Legacy section logic you added
...
//             >
//               <button className="bg-[#d0a539] text-[#171512] px-8 py-4 rounded-lg text-xs md:text-sm font-black uppercase tracking-widest hover:bg-white transition-colors duration-300 shadow-xl shadow-[#d0a539]/20">
//                 Explore Ecosystem
//               </button>
//               <button className="bg-white/5 backdrop-blur-md text-white border border-white/20 px-8 py-4 rounded-lg text-xs md:text-sm font-black uppercase tracking-widest hover:bg-white/10 transition-all duration-300 group">
//                 Annual Report{" "}
...
//                   // Fixed Classes:
//                   // 1. changed -left-6 to left-4 for mobile (keeps it inside)
//                   // 2. changed p-6 to p-4 for mobile (smaller padding)
//                   // 3. md: classes restore the original large, overlapping look on desktop
...
//                 >
//                   {/* Smaller text on mobile (text-2xl), larger on desktop (md:text-4xl) */}
...
//       {/* Legacy Section (Cleaned up and color corrected) */}
