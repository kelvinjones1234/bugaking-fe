...
// --- Optimization 2: Static Formatter (Outside Component) ---
...
// --- Optimization 3: Memoized Sub-Components ---

// A. Status View (Loading/Success)
const StatusView = memo(({ status }: { status: "loading" | "success" }) => (
  <div className="w-full flex flex-col items-center justify-center p-8 sm:p-12 text-center space-y-6 min-h-[400px]">
    {status === "loading" ? (
      <>
        <Loader2 className="w-12 h-12 sm:w-16 sm:h-16 text-[#d0a539] animate-spin" />
...
const ProjectDetailModal: React.FC<ProjectDetailModalProps> = ({
  ...
  }, [project, currentPlan, isAuthenticated, selectedPlanId, router, onClose]);
