...
// interface MainProps {
//   onNavigateToDetail: (id: number) => void; // Updated to accept ID
// }

// const Main = ({ onNavigateToDetail }: MainProps) => {
//   const [investments, setInvestments] = useState<Investment[]>([]);
//   const [activeFilter, setActiveFilter] = useState<string>("all"); // 'all', 'real-estate', 'agriculture'
...
//     setLoading(true);
//     try {
//       // Pass the category to the API (undefined if 'all')
...
//   // --- 2. Effect: Refetch when filter changes ---
//   useEffect(() => {
...
//           {/* Filter Buttons: Update state on click */}
//           <button
...
//               {investments.length} Active Projects
//             </p>
//           </div>
//         </div>
//       </div>
...
//         {loading ? (
//           <p className="text-center text-[#171512]/40 animate-pulse">
//             Loading investments...
//           </p>
//         ) : investments.length === 0 ? (
//           <p className="text-center text-[#171512]/40">
...
//             <div
//               key={inv.id}
//               onClick={() => onNavigateToDetail(inv.id)} // Pass ID to navigation
...
//                   // If project_image is relative from Django, prepend base URL if needed, or assume proxy
...
//                 <div
//                   className={`grid gap-4 ${inv.investment_type === "real-estate" ? "grid-cols-2 xl:grid-cols-1" : "grid-cols-1"}`}
//                 >
//                   {/* 1. Next Due Block (Always Visible) */}
//                   <div className="bg-[#d0a539]/10 p-3 sm:p-4 rounded-xl border border-[#d0a539]/20">
//                     <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-[#d0a539]/80">
//                       Next Due
//                     </p>
//                     <p className="text-base sm:text-lg font-black text-[#171512]">
//                       {inv.formatted_next_due}
//                     </p>
//                     <p className="text-xs sm:text-sm font-bold text-[#d0a539]">
//                       {inv.days_left !== null
//                         ? `${inv.days_left} Days Left`
//                         : "Completed"}
//                     </p>
//                   </div>

//                   {/* 2. ROI Block (ONLY visible for Farmland/Agriculture) */}
//                   {inv.investment_type === "agriculture" && (
//                     <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center px-1">
//                       <p className="text-[10px] font-black uppercase tracking-widest text-[#171512]/40">
//                         ROI
//                       </p>
//                       <p className="text-base sm:text-lg font-black text-[#171512]">
...
//                     className="w-full bg-[#d0a539] disabled:bg-gray-300 text-[#171512] font-black uppercase tracking-widest py-3 rounded-lg text-[10px] hover:bg-[#d0a539]/90 transition-colors"
//                   >
//                     Make Payment
//                   </button>
//                   <div className="flex gap-2">
//                     <button className="flex-1 bg-[#171512]/5 text-[#171512] text-[10px] font-black uppercase tracking-widest py-3 rounded-lg hover:bg-[#171512]/10 transition-colors">
//                       Details
//                     </button>
//                     <button className="flex-1 bg-[#171512]/5 text-[#171512] text-[10px] font-black uppercase tracking-widest py-3 rounded-lg hover:bg-[#171512]/10 transition-colors">
//                       Docs
