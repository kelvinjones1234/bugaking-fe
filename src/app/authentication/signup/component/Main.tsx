...
//   return (
//     // h-full ensures it takes up all the space given by the parent (flex-1)
...
//                   >
//                     I agree to the{" "}
//                     <a href="#" className="text-[#d0a539] font-bold hover:underline">
//                       Terms of Service
//                     </a>
//                     .
//                   </label>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center gap-3 py-2">
              <input
                ...
                id="terms"
                type="checkbox"
                className="mb-1 rounded border-gray-300 text-[#d0a539] focus:ring-2 focus:ring-[#d0a539] cursor-pointer"
              />
              <label
                className="text-xs leading-relaxed text-[#171512]/60 cursor-pointer select-none"
                htmlFor="terms"
              >
                I agree to the{" "}
                <a href="#" className="text-[#d0a539] font-bold hover:underline">
